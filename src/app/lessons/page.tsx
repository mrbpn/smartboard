...
export default function LessonsPage() {
  ...
  async function load() {
    try { setLessons((await lessonsDb.list()) as Lesson[]); }
  ...
  async function handleDelete() {
    ...
    setDeleting(true);
    try { await lessonsDb.softDelete(deleteTarget.id); setDeleteTarget(null); await load(); }
